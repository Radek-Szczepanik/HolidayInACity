...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("HolidayInACity.Domain.Entities.EventOrganizer", b =>
                {
                    ...
                    b.Property<int>("EventOrganizerAddressId")
                        .HasColumnType("int");

                    b.Property<int>("EventOrganizerContactId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("HolidayInACity.Domain.Entities.EventOrganizerAddress", b =>
                {
                    b.HasOne("HolidayInACity.Domain.Entities.EventOrganizer", "EventOrganizer")
                        .WithOne("EventOrganizerAddress")
                        .HasForeignKey("HolidayInACity.Domain.Entities.EventOrganizerAddress", "Id")
            ...
            modelBuilder.Entity("HolidayInACity.Domain.Entities.EventOrganizerContact", b =>
                {
                    b.HasOne("HolidayInACity.Domain.Entities.EventOrganizer", "EventOrganizer")
                        .WithOne("EventOrganizerContact")
                        .HasForeignKey("HolidayInACity.Domain.Entities.EventOrganizerContact", "Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("HolidayInACity.Domain.Entities.EventOrganizer", b =>
                {
                    b.Navigation("EventOrganizerAddress")
                        .IsRequired();

                    b.Navigation("EventOrganizerContact")
                        .IsRequired();
